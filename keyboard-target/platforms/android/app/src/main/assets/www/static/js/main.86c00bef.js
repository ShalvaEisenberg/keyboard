...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stores = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyboardLetters = __webpack_require__(9);
	
	var _keyboardLetters2 = _interopRequireDefault(_keyboardLetters);
	
	var _keyboardTopRows = __webpack_require__(11);
	
	var _keyboardTopRows2 = _interopRequireDefault(_keyboardTopRows);
	
	var _keyboardSideKeys = __webpack_require__(10);
	    ...
	    function Keyboard(props) {
	        ...
	        _this.progress = function () {
	            ...
	            if (_this.state.lettersRight / _this.state.lettersWrong > 0.75 && _this.state.progress < 8) {
	                ...
	                _this.setState(newState);
	                _this.props.Keyboard.progress = _this.props.Keyboard.progress + 1 / _this.props.Keyboard.wordsPerLevel;
	    ...
	    _createClass(Keyboard, [{
	        ...
	        value: function render() {
	            ...
	            if (this.state.imagePreviewUrl) {
	                imagePreview = _react2.default.createElement('img', { src: this.state.imagePreviewUrl, alt: 'icon' });
	            }
	            return _react2.default.createElement(
	                'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Keyboard = function Keyboard() {
	    ...
	    this.changeLang = function (lang) {
	        console.log("a this.lang: ", _this.lang);
	        _this.lang = lang;
	        console.log("b this.lang: ", _this.lang);
	    };
	};
